...
//?maasi 6000 ile 10000 tl arasindaki arkadaslara %10 zam yapip bu maaşların toplamini hesaplayacagiz

const zamliMayişToplami = mayişlar.filter(m => m >= 6000 && m <= 10000).map(m => m * 1.1).reduce((t , m) => t + m)

console.log("ZAMLI MAASLAR:", zamliMaaşlarToplami)
