...
import birdBlue from "./img/bird-blue.jpg"
...
const Content = () => {
  ...
  return (
    <main>
        ...
        <p style={parStyle}>React is JS libary</p>
        <img style={imgStyle}
      ...
      <img style={imgStyle}
        ...
        alt=""
      />
      <img style={imgStyle} src={birdBlue} alt="bird-blue" />
      <img style={imgStyle} src="./assets/dandelion.jpg" alt="dandelion" />
        <p style={parStyle}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos, tenetur!</p>
