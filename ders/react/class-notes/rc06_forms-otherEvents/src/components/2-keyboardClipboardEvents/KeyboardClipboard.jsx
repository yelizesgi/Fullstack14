...
const KeyboardClipboard = () => {
  ...
  const handleKeyDown = (e)=>{
    if(e.keyCode >= 48 && e.keyCode <= 57){
      ...
      e.preventDefault()//rakam yazılmasını doğal davranışı engelleyerek engelledik
    }
  }
  ...
  return (
    <div className="container mt-4">
      ...
      <textarea className="form-control" name="" id="" cols="30" rows="10" onPaste={handlePaste}></textarea>
    </div>
